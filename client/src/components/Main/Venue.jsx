            ...
            <div className="search-list-grid">
                {props.venues.map((venue) => (
                    <div className="search-list-card">
                        ...
                        <div className="list-card-subtitle">{venue.state} • {location.country}</div>
                        ...
                        <button className="list-card-button-venue" onClick={() => showLocation(venues)} key={venue.id}>explore</button>
                    </div>
                ))}
            </div>
        </div>
